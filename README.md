...
| <a name="input_list_of_accounts_access_log_bucket"></a> [list\_of\_accounts\_access\_log\_bucket](#input\_list\_of\_accounts\_access\_log\_bucket) | List of accounts that should be able to read logs from logs bucket | `list(string)` | `[]` | no |
