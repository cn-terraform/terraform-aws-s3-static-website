...
| <a name="input_cloudfront_default_cache_policy_id"></a> [cloudfront\_default\_cache\_policy\_id](#input\_cloudfront\_default\_cache\_policy\_id) | (Optional) The cache policy ID for the default cache behavior. Defaults to Managed-CachingOptimized (658327ea-f89d-4fab-a63d-7e88639e58f6). Use 4135ea2d-6df8-44a3-9df3-4b5a84be39ad for Managed-CachingDisabled. | `string` | `"658327ea-f89d-4fab-a63d-7e88639e58f6"` | no |
| <a name="input_cloudfront_default_origin_request_policy_id"></a> [cloudfront\_default\_origin\_request\_policy\_id](#input\_cloudfront\_default\_origin\_request\_policy\_id) | (Optional) The origin request policy ID for the default cache behavior. Defaults to Managed-CORS-S3Origin (88a5eaf4-2fd4-4709-b370-b4c650ea3fcf). | `string` | `"88a5eaf4-2fd4-4709-b370-b4c650ea3fcf"` | no |
